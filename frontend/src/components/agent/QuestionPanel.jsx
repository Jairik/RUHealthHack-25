  ...
  <div className="absolute right-3 top-3">
    {isListening ? (
      ...
      <Button
        ...
        className={`w-8 h-8 rounded-full shadow-md transition-all duration-200 ${isSpeechRecognitionSupported
...
export default function QuestionPanel({ currentQuestion, questionHistory, onSubmitAnswer, loading }) {
  ...
  const getAnswerBadgeColor = (type) => {
    switch (type) {
      ...
      default: return 'bg-rose-200 dark:bg-rose-900 text-rose-900 dark:text-rose-100 border-rose-400 dark:border-rose-600';
    }
  };
      ...
      <CardContent>
              ...
              return (
                ...
                >
                  ...
                  <div className="ml-6">
                    ...
                    {answerData.note && (
                      <div className="p-3 bg-rose-100 dark:bg-rose-900/30 rounded-xl border-2 border-rose-300 dark:border-rose-700">
        ...
        {currentQuestion && (
          <div className="space-y-4">
            <div className="p-5 bg-gradient-to-r from-red-600 via-red-500 to-rose-500 dark:from-red-700 dark:via-red-600 dark:to-rose-600 rounded-xl text-white">
              ...
              {isFirstQuestion ? (
                ...
                <>
                  <div>
                    ...
                    <div className="relative">
                      <Textarea
                        ...
                        rows={5}
                        disabled={loading}
                        className="text-base bg-white dark:bg-slate-950 text-red-900 dark:text-red-100 border-2 border-red-300 dark:border-red-700 font-semibold resize-none pr-14"
                      />
                      <MicButton
                        isListening={isListeningInitial}
                        startListening={startListeningInitial}
                  ...
                  <Button
                    ...
                    className="w-full text-lg px-8 py-6 bg-gradient-to-r from-red-600 via-red-500 to-rose-500 dark:from-red-700 dark:via-red-600 dark:to-rose-600 hover:scale-105 shadow-xl text-white font-black disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? (
                      <>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-4">
                      <Button
                        ...
                        disabled={loading}
                        className={`h-20 text-lg font-black ${selectedAnswer === 'Yes'
                      ...
                      <Button
                        ...
                        disabled={loading}
                        className={`h-20 text-lg font-black ${selectedAnswer === 'No'
                      ...
                      <Button
                        ...
                        disabled={loading}
                        className={`h-20 text-lg font-black ${selectedAnswer === 'Skip'
