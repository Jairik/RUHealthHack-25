...
export default function PatientInfoForm({ onSubmit, loading }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-white to-cyan-50 dark:from-gray-950 dark:via-purple-950 dark:to-gray-900 py-12 px-6">
      <motion.div
        ...
        <Card className="border-4 border-blue-300 dark:border-purple-700 shadow-2xl bg-white dark:bg-gray-900">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label className="block text-base font-bold mb-3 text-blue-800 dark:text-purple-200 flex items-center gap-2">
                ...
                <Input
                  ...
                  className={`text-lg bg-white dark:bg-gray-950 text-blue-900 dark:text-purple-100 border-3 ${
                    errors.agentId 
                      ? 'border-red-500 dark:border-red-600' 
                      : 'border-blue-400 dark:border-purple-600'
                  } focus:border-blue-600 dark:focus:border-purple-400 font-semibold`}
                />
                {errors.agentId && (
              ...
              <div className="pt-4 border-t-2 border-blue-200 dark:border-purple-800">
                <p className="text-sm font-bold text-blue-700 dark:text-purple-300 mb-4">
                  Patient Information:
                </p>
              </div>
